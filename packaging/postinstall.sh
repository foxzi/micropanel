...
echo "  2. Setup nginx: /usr/share/micropanel/scripts/setup-panel-nginx.sh"
echo "  3. Start service: systemctl enable --now micropanel"
echo "  4. (Optional) Enable SSL: certbot --nginx -d your-panel-domain"
echo ""
